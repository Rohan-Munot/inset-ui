...
const NeuralFlowMaterial = shaderMaterial(
  {
    iTime: 0,
    iResolution: new THREE.Vector2(1, 1),
    uSpeed: 1.0,
    uComplexity: 1.0,
    uColorTint: new THREE.Vector3(1, 1, 1),
  },
  vertexShader,
  fragmentShader
);

extend({ NeuralFlowMaterial });

// TypeScript declaration for custom material
declare module "@react-three/fiber" {
  interface ThreeElements {
    neuralFlowMaterial: any;
  }
}
...
function Scene({ speed, complexity, colorTint }: SceneProps) {
...
// ===================== COMPONENT =====================
export interface NeuralFlowProps {
  /**
  ...
  /**
   * Pattern complexity/zoom level
   * @default 1.0
   */
  complexity?: number;

  /**
   * RGB color tint (0-1 range for each channel)
  ...
  /**
   * Show gradient overlays (top/bottom fade)
   * @default true
   */
...
export function NeuralFlow({
  ...
  const colorTintVec = useMemo(
    () => new THREE.Vector3(colorTint[0], colorTint[1], colorTint[2]),
    [colorTint]
  );

  return (
    <div className="inset-0 -z-10 h-full w-full" aria-hidden="true">
      <div
